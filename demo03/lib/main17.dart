/*
 ...
 즉, 다형성이란 BMW 에게 너 엔진이야? 라고 물었을 떄 '어 나 엔진이야'
 라고 답을 할 수있어야 된다.(즉 잘못된 상속)
...
void main() {
  ...
  // cb.ch_name; 보임
  // 주요 핵심 개념
  // 치즈 버거는 다형성을 가집니다. 버거이기도 하고 치즈버거 이기도 하다.
  // ---------------
  print('---------------------');
  ...
  // b2.ch_name; 보이게 하곻 싶다면 더떻게 코드를 작성해야 하나요?
  Burger b3 = CheeseBurger();
  CheeseBurger b4 = b3 as CheeseBurger;
  print(b4.ch_name);
  print('버거 데이터 타입에서 ch_name 을 호출하자 ${(b3 as CheeseBurger).ch_name}');
}
